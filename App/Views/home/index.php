...
<div id="demo" class="carousel slide centralizar" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <p><img src="http://<?php echo APP_HOST ?>/public/image/banner/pokee.jpg" class="img-fluid" alt="Responsive image"></p> 
        </div>
        <div class="carousel-item active">
           <p><img src="http://<?php echo APP_HOST ?>/public/image/banner/saladacenoura.jpg" class="img-fluid" alt="Responsive image"></p> 
        </div>
        <div class="carousel-item active">
            <p><img src="http://<?php echo APP_HOST ?>/public/image/banner/brazo-gitano.jpg" class="img-fluid" alt="Responsive image"></p> 
        </div>
        <div class="carousel-item active">
            <p><img src="http://<?php echo APP_HOST ?>/public/image/banner/tortaSalgada.jpg" class="img-fluid" alt="Responsive image"></p> 
        </div>
    </div>
          <!-- adicionei -->
</div>   
